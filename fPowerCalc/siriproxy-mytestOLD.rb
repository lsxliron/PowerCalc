...
listen_for /Door ([a-z]*) ([a-z]*) ([a-z]*) ([0-9,]*[0-9].*[0-9])/i do |software, client, function, args|
...
#						sleep 5
#						sftp.download!(function + ".pdf", Dir.home + "/PowerCalcTempFiles/sample2.pdf")
#						sleep 5
#						puts "DEBUG: BOTH SAMPLES DOWNLOADED. CHECKING SIZE..."
#						puts File.size(Dir.home + "/PowerCalcTempFiles/sample1.pdf")
#						puts File.size(Dir.home + "/PowerCalcTempFiles/sample2.pdf")
#
#						#CALCULATE THE SIZE DIFFERENCE
#						diff = Integer(File.size(Dir.home + "/PowerCalcTempFiles/sample1.pdf")) - Integer(File.size(Dir.home + "/PowerCalcTempFiles/sample2.pdf"))
...
#						else
#							fileReady = false
#							put "FILE IS NOT COMPLETE YET, WILL TRY AGAIN"
#						end
					end
