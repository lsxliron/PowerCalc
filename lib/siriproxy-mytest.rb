...
class SiriProxy::Plugin::Mytest < SiriProxy::Plugin
  ...
  #JUST FOR TESTING#####
  listen_for /who is using my computer/i do
    #say "Hold on, Taking a snapshot."
    system "sudo -u lsxliron streamer -f jpeg -o ~/Desktop/temp.jpeg"
    #say "Sending the snapshot to your email"
    system "sudo -u lsxliron python ~/Desktop/sendEmail.py"
    system "sudo rm -u lsxlirn rm ~/Desktop/temp.jpeg"
    say "An email was sent to your inbox"
    #object = SiriAddViews.new
    #object.make_root(last_ref_id)
    #answer = SiriAnswer.new("Image will go here when using webcams", [
    #SiriAnswerLine.new("", "https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcQDzRVQXGQAf0wVdFSgjhty3h2Z5eYbPU07WCO3wMujkAVzCpJ_")
#])
