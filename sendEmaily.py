...
#VARIABLES TO SETUP
def send_mail(user, passwd, attch_name):
    attachmentname =  attch_name#path to an attachment, if you wish
    username = 'yonatanshimroni@gmail.com'	
    password = ' av201257 '
    

    fromaddr = 'yonatanshimroni@gmail.com>' #must be a vaild 'from' addy in your GApps account
    toaddr  = 'yonatanshimroni@gmail.com'
    ...
    #ddd= email.utils.parseaddr(username)
    #print ddd
    #htmlmsgtext = """This person is using your computer <br/>{}<br/><br/>.""".format(time)
    htmlmsgtext = "ffffffffffffffffffffffffffffffff"
    #--------------------------------------------------------------------------------
